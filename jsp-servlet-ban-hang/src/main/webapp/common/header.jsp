		...
		<nav class="navbar navbar-expand-lg navbar-light main_box">
			<div class="container">
				...
				<a class="navbar-brand logo_h" href="home"><img
					src="<c:url value='/template/img/logo.png"'/> alt=""></a>
				...
				<div class="collapse navbar-collapse offset"
					...
					<ul class="nav navbar-nav menu_nav ml-auto">
						...
						<c:if test="${sessionScope.acc != null}">
							<li class="nav-item submenu dropdown"><a href="#"
								class="nav-link dropdown-toggle" data-toggle="dropdown"
								role="button" aria-haspopup="true" aria-expanded="false">${sessionScope.acc.username}</a>
								<ul class="dropdown-menu">
		...
		<div class="container">
			<form class="d-flex justify-content-between" action="search"
				...
				<input type="text" class="form-control" id="search_input"
					placeholder="Search Here" name="txt">
