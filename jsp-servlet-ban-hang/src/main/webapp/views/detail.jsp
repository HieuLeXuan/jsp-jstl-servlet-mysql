...
<%@page import="com.hieulexuan.models.Product"%>
			...
			<div class="row s_product_inner">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						List<String> desList = Arrays.asList(pro.getDescription().split("\\s*,\\s*"));
						%>
						<c:forEach var="d" items="<%=desList%>">
							<ul class="list my-2">
								<c:if test="d != null">
									<li>* ${d}</li>
								</c:if>
						...
						<div class="col-lg-6">
							<div class="comment_list">
								<div class="review_item">
									<div class="media">
										<div class="d-flex">
											<img src="<c:url value='template/img/product/review-1.png'/>"
												alt="">
										</div>
								...
								<div class="review_item reply">
									<div class="media">
										<div class="d-flex">
											<img src="<c:url value='template/img/product/review-2.png'/>"
												alt="">
										</div>
										<div class="media-body">
											<h4>Blake Ruiz</h4>
								...
								<div class="review_item">
									<div class="media">
										<div class="d-flex">
											<img src="<c:url value='template/img/product/review-3.png'/>"
												alt="">
										</div>
										<div class="media-body">
											<h4>Blake Ruiz</h4>
